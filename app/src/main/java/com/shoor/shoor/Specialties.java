...
public class Specialties extends AppCompatActivity {
    ...
    public void setSpecialtyClicked(String sp ,String id) {
        ...
        specialty.setName(sp);
        specialty.setID(id);
        //set session SpecialtyClicked
        SharedPreferences sharedpreferences = getSharedPreferences(specialty.getName(), Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedpreferences.edit();
        editor.putString("SpecialtyName", specialty.getName());
        editor.apply();

        //set session SpecialtyClicked
        SharedPreferences sharedpreferences2 = getSharedPreferences(specialty.getID(), Context.MODE_PRIVATE);
        SharedPreferences.Editor editor2 = sharedpreferences2.edit();
        editor2.putString("Specialty_ID", specialty.getID());
        editor2.apply();
        //redirect to doctors
        startActivity(new Intent(Specialties.this, Doctors.class));
    }

    public void linkToFavorite(View view) {
        this.finish();
        startActivity(new Intent(Specialties.this,FavoriteList.class));

    }

    public void linkToMyprofile(View view) {
        this.finish();
        startActivity(new Intent(Specialties.this,ProfileActivity.class));
    }

    public void linkToSpecialty(View view) {
        //redirect to suggest activity
        this.finish();
        startActivity(new Intent(Specialties.this, Specialties.class));
    }

    public void linkToSuggest(View view) {
        //redirect to suggest activity
        this.finish();
        startActivity(new Intent(Specialties.this, SuggestDoctorActivity.class));
    }
